    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 36, justifyContent: 'center' }}>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 600, marginBottom: 6, letterSpacing: '-0.02em', textAlign: 'center'}}>Iniciá sesión</h1>
          <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', marginBottom: 28, textAlign: 'center' }}>Bienvenido de vuelta</p>
